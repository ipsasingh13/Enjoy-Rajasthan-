export const translations: Record<string, Record<string, string>> = {
  ...
  hi: {
    ...
    navMap: "स्थानों का मानचित्र",
    navPostcards: "डिजिटल पोस्टकार्ड",
    navPacking: "पैकिंग सूची",
    navLogin: "शाही लॉगिन",
  ...
  ra: {
    ...
    navWeather: "मौसम री जानकारी",
    navInteractive: "शाही सेंसर",
    navMap: "जगह रो नक़्शो",
    navPostcards: "शाही पोस्टकार्ड",
    navPacking: "सामान री लिस्ट",
...
export const attractionDetailsInfo: Record<string, any> = {
  ...
  'Ajmer Sharif Dargah': {
    description: 'The revered shrine of Sufi saint Moinuddin Chishti. It is a place of immense spiritual significance for people of all faiths.',
    timings: '05:00 AM - 09:00 PM',
    fee: 'Free Entrance',
    tip: 'Cover your head before entering. Prepare for large crowds, especially during Friday prayers.',
    image: 'https://images.unsplash.com/photo-1590005354167-6da97870c913?auto=format&fit=crop&w=600&q=80'
  },
  'Ana Sagar Lake': {
    description: 'A beautiful artificial lake built by Anaji Chauhan in the 12th century, featuring elegant marble pavilions (Baradari) added by Mughal emperor Shah Jahan.',
    timings: '08:00 AM - 08:00 PM',
    fee: 'Free (Boating extra)',
    tip: 'Enjoy a peaceful evening boat ride as the sun sets behind the surrounding hills.',
    image: 'https://images.unsplash.com/photo-1615836245337-f5b9b230bc18?auto=format&fit=crop&w=600&q=80'
  },
  'Bhangarh Fort': {
    description: 'Famous as the most haunted fort in India, these fascinating 17th-century ruins offer brilliant architecture surrounded by lush green hills.',
    timings: '06:00 AM - 06:00 PM',
    fee: '₹25 (Indians), ₹200 (Foreigners)',
    tip: 'Entry is strictly prohibited before sunrise and after sunset due to local legends.',
    image: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=600&q=80'
  },
  'Sariska Tiger Reserve': {
    description: 'Nestled in the Aravalli Hills, this reserve is known for its Bengal tigers, leopards, and ancient Neelkanth temple ruins inside the park.',
    timings: '06:00 AM - 09:30 AM, 03:00 PM - 06:00 PM',
    fee: 'Varies based on zone and vehicle',
    tip: 'Jeep safaris must be booked well in advance. Winter mornings offer the best wildlife sightings.',
    image: 'https://images.unsplash.com/photo-1603258591321-df626c11d2bc?auto=format&fit=crop&w=600&q=80'
  },
  'Mandawa Fort & Havelis': {
    description: 'An open-air art gallery featuring breathtaking 18th-century painted mansions (havelis) adorned with intricate frescoes and royal mirror work.',
    timings: '09:00 AM - 06:00 PM',
    fee: '₹250 (Includes fort entry)',
    tip: 'Take a walking tour with a local heritage guide to discover hidden frescoes depicting ancient trade routes.',
    image: 'https://images.unsplash.com/photo-1590005354167-6da97870c913?auto=format&fit=crop&w=600&q=80'
  },
  'Murmuria Haveli': {
    description: 'Famous for its unique blend of traditional Rajasthani art and early 20th-century European influences, including paintings of cars, trains, and royals.',
    timings: '08:00 AM - 06:00 PM',
    fee: '₹100 per person',
    tip: 'Early morning light is best for capturing the detailed colors of the courtyard wall paintings.',
    image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=600&q=80'
  },
  'Chambal Riverfront & Garden': {
    description: 'A grand world-class riverfront promenade in Kota along the Chambal River, featuring illuminated statues, music fountains, and marble plazas.',
    timings: '06:00 AM - 10:00 PM',
    fee: '₹200 entrance ticket',
    tip: 'Visit in the evening for the spectacular LED light show and river cruise experience.',
    image: 'https://images.unsplash.com/photo-1615836245337-f5b9b230bc18?auto=format&fit=crop&w=600&q=80'
  },
  'Seven Wonders Park Kota': {
    description: 'A charming theme park located on the banks of Kishore Sagar lake, featuring detailed replicas of all seven wonders of the world.',
    timings: '04:30 PM - 10:00 PM',
    fee: '₹20 per person',
    tip: 'Sunset at the lake with illuminated miniature monuments makes for great family photography.',
    image: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=600&q=80'
  },
  'Taragarh Fort Bundi': {
    description: 'Built in 1354, this imposing hilltop fortress offers panoramic views of Bundi, featuring massive stone ramparts and ancient water reservoirs.',
    timings: '08:00 AM - 05:00 PM',
    fee: '₹100 (Indians), ₹500 (Foreigners)',
    tip: 'Wear good walking shoes as the stone ramp path uphill can be steep.',
    image: 'https://images.unsplash.com/photo-1590005354167-6da97870c913?auto=format&fit=crop&w=600&q=80'
  },
  'Raniji Ki Baori Stepwell': {
    description: 'Built in 1699 by Rani Nathavati, this 46-meter deep stepwell is a masterpiece of carved stone pillars, arched gates, and intricate stone carvings.',
    timings: '09:00 AM - 05:00 PM',
    fee: '₹50 per person',
    tip: 'Notice the finely sculpted Elephant capitals on the central pillars down the stairs.',
    image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=600&q=80'
  },
  'Keoladeo Bird Sanctuary': {
    description: 'A UNESCO World Heritage site in Bharatpur hosting over 370 bird species, including migratory Siberian cranes and painted storks.',
    timings: '06:00 AM - 06:00 PM',
    fee: '₹75 (Indians), ₹500 (Foreigners)',
    tip: 'Hire a rickshaw puller who doubles as a trained ornithologist guide for the best bird sightings.',
    image: 'https://images.unsplash.com/photo-1603258591321-df626c11d2bc?auto=format&fit=crop&w=600&q=80'
  },
  'Lohagarh Fort': {
    description: 'The Iron Fort of Bharatpur built by Maharaja Suraj Mal. Famous for withstanding numerous British sieges due to its massive mud walls.',
    timings: '09:00 AM - 05:30 PM',
    fee: 'Free (Museum ₹20)',
    tip: 'Visit the Government Museum inside the fort to inspect ancient arms, coins, and royal carvings.',
    image: 'https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=600&q=80'
  },
  'Gagron Fort': {
    description: 'A rare UNESCO World Heritage water fort surrounded on three sides by the Ahu and Kali Sindh rivers in Jhalawar.',
    timings: '09:00 AM - 05:00 PM',
    fee: '₹50 per person',
    tip: 'The river view from the top battlements is breathtaking, particularly during late monsoon months.',
    image: 'https://images.unsplash.com/photo-1590005354167-6da97870c913?auto=format&fit=crop&w=600&q=80'
  },
  'Kolvi Buddhist Caves': {
    description: 'Ancient 5th to 9th-century rock-cut Buddhist caves featuring stupas, meditation cells, and carved Buddha statues carved directly into laterite hills.',
    timings: '08:00 AM - 05:00 PM',
    fee: 'Free entry',
    tip: 'A quiet, offbeat heritage site perfect for travelers interested in ancient archaeology.',
    image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=600&q=80'
  }
};
...
export const cityDaysDatabase: Record<string, any[]> = {
  ...
  'Ajmer': [
    { title: "Ajmer Spiritual Sites", spots: ["Ajmer Sharif Dargah", "Ana Sagar Lake"], time: "09:00 AM - 06:00 PM" }
  ],
  'Alwar': [
    { title: "Alwar Forts & Wildlife", spots: ["Bhangarh Fort", "Sariska Tiger Reserve"], time: "08:00 AM - 05:00 PM" }
  ],
  'Mandawa': [
    { title: "Shekhawati Open-Air Art Gallery", spots: ["Mandawa Fort & Havelis", "Murmuria Haveli"], time: "09:00 AM - 06:00 PM" }
  ],
  'Kota': [
    { title: "Kota Riverfront & Modern Heritage", spots: ["Chambal Riverfront & Garden", "Seven Wonders Park Kota"], time: "09:00 AM - 09:00 PM" }
  ],
  'Bundi': [
    { title: "Bundi Stepwells & Hill Forts", spots: ["Taragarh Fort Bundi", "Raniji Ki Baori Stepwell"], time: "08:30 AM - 05:30 PM" }
  ],
  'Bharatpur': [
    { title: "Bharatpur Birds & Iron Fortress", spots: ["Keoladeo Bird Sanctuary", "Lohagarh Fort"], time: "06:00 AM - 06:00 PM" }
  ],
  'Jhalawar': [
    { title: "Jhalawar Water Fort & Cave Shrines", spots: ["Gagron Fort", "Kolvi Buddhist Caves"], time: "08:30 AM - 05:30 PM" }
  ]
};
...
export const weatherDatabase: Record<string, any> = {
  ...
  'Ajmer': { temp: '32', rain: '11', wind: '10' },
  'Alwar': { temp: '31', rain: '14', wind: '12' },
  'Mandawa': { temp: '33', rain: '7', wind: '11' },
  'Kota': { temp: '34', rain: '16', wind: '9' },
  'Bundi': { temp: '32', rain: '14', wind: '10' },
  'Bharatpur': { temp: '31', rain: '13', wind: '11' },
  'Jhalawar': { temp: '33', rain: '18', wind: '8' }
};
...
export const vectorMapNodes = [
  ...
  { name: 'Ajmer', x: 280, y: 165 },
  { name: 'Alwar', x: 340, y: 130 },
  { name: 'Mandawa', x: 290, y: 120 },
  { name: 'Kota', x: 340, y: 250 },
  { name: 'Bundi', x: 320, y: 235 },
  { name: 'Bharatpur', x: 390, y: 150 },
  { name: 'Jhalawar', x: 350, y: 285 }
];

export const destinationsList = ['Jaipur', 'Udaipur', 'Jodhpur', 'Jaisalmer', 'Mount Abu', 'Pushkar', 'Bikaner', 'Ranthambore', 'Chittorgarh', 'Ajmer', 'Alwar', 'Mandawa', 'Kota', 'Bundi', 'Bharatpur', 'Jhalawar'];

export const attractionsData: Record<string, string[]> = {
  "Historical Forts": ['Amer Fort', 'Nahargarh Fort', 'Jaigarh Fort', 'City Palace Jaipur', 'Mehrangarh Fort', 'Umaid Bhawan Palace', 'Jaisalmer Fort', 'Chittorgarh Fort', 'Kumbhalgarh Fort', 'Junagarh Fort', 'City Palace Udaipur', 'Bhangarh Fort', 'Mandawa Fort & Havelis', 'Taragarh Fort Bundi', 'Lohagarh Fort', 'Gagron Fort'],
  "Spiritual Temples": ['Khatu Shyam Ji', 'Salasar Balaji', 'Brahma Temple', 'Karni Mata Temple', 'Dilwara Jain Temples', 'Jaswant Thada Cenotaph', 'Ajmer Sharif Dargah', 'Kolvi Buddhist Caves'],
  "Wildlife Preserves": ['Ranthambore National Park', 'Sariska Tiger Reserve', 'Keoladeo Bird Sanctuary'],
  "Architecture Highlights": ['Hawa Mahal', 'Jantar Mantar', 'Patwon Ki Haveli', 'Saheliyon Ki Bari', 'Sajjangarh Monsoon Palace', 'Murmuria Haveli', 'Raniji Ki Baori Stepwell', 'Seven Wonders Park Kota'],
  "Experiences": ['Lake Pichola Boat Ride', 'Sam Sand Dunes Camel Ride', 'Desert Sunset Jeep Safari', 'Nakki Lake Boating', 'Pushkar Lake Ghats & Parikrama', 'Mandore Gardens', 'Ana Sagar Lake', 'Chambal Riverfront & Garden'],
  "Famous Food": ['Dal Bati Churma', 'Laal Maas', 'Ghevar', 'Pyaaz Kachori', 'Kota Kachori', 'Bikaner Bhujia']
};
...
export const rajasthanHotelsData = [
  {
    id: 'rambagh-palace-jaipur',
    name: 'Rambagh Palace',
    city: 'Jaipur',
    category: 'Heritage Palace' as const,
    pricePerNight: '₹32,000 / night',
    priceNumeric: 32000,
    rating: 4.9,
    reviewsCount: 480,
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=600&q=80',
    description: 'Former residence of the Maharaja of Jaipur, featuring manicured peacock gardens, marble archways, and royal dining.',
    amenities: ['Jiva Grand Spa', 'Peacock Gardens', 'Butler Service', 'Indoor & Outdoor Pools', 'Vintage Car Rental'],
  ...
  },
  {
    ...
    description: 'A floating white-marble jewel in the middle of Lake Pichola offering unmatched romantic vistas of Udaipur.',
    amenities: ['Boat Shuttle Transfer', 'Jharokha Lake Dining', 'Heritage Spa Boat', 'Royal Welcome'],
  ...
  },
  {
    ...
    description: 'Perched high above Jodhpur, this art-deco golden sandstone palace is one of the world’s largest private residences.',
    amenities: ['Private Museum Access', 'Subterranean Pool', 'Polo Lawns', 'Fine Dining Courtyard'],
    address: 'Circuit House Road, Jodhpur'
  },
  {
    id: 'suryagarh-jaisalmer',
    name: 'Suryagarh Sandstone Fortress',
    city: 'Jaisalmer',
    ...
    description: 'A magnificent golden sandstone fortress gateway to the Thar desert, combining ancient folklore with luxury suites.',
    amenities: ['Desert Safaris', 'Rooftop Sundowners', 'Archery Grounds', 'Open Air Courtyard'],
    address: 'Kahala Phata, Jaisalmer'
  },
  {
    ...
    reviewsCount: 610,
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=600&q=80',
    description: 'Spread over 50 acres on the banks of Lake Pichola, featuring interconnecting dome pools, private courtyards, and wildlife sanctuaries.',
    amenities: ['Semiprivate Moat Pools', 'Private Lake Cruise', 'Ayurvedic Spa', 'Lakeside Fine Dining'],
    address: 'Haridas Ji Ki Magri, Udaipur'
  },
  {
    id: 'samode-haveli-jaipur',
    name: 'Samode Haveli Heritage Residence',
    city: 'Jaipur',
    category: 'Boutique Haveli' as const,
    pricePerNight: '₹14,500 / night',
    priceNumeric: 14500,
    rating: 4.7,
    reviewsCount: 280,
    image: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=600&q=80',
    description: 'A 220-year-old regal urban haveli with hand-painted fresco walls, leafy courtyard gardens, and a mosaic pool.',
    amenities: ['Mural Fresco Rooms', 'Verandah Dining', 'Heritage Mosaic Pool', 'Central Location'],
    address: 'Gangapole, Jaipur'
  },
  {
    id: 'raas-jodhpur',
    name: 'RAAS Jodhpur Sandstone Hotel',
    city: 'Jodhpur',
    category: 'Boutique Haveli' as const,
    ...
    description: 'A boutique sandstone retreat nestled directly underneath Mehrangarh Fort with spectacular illuminated night fort views.',
    amenities: ['Fort View Rooftop Restaurant', 'Organic Gardens', 'Heated Pool', 'Stepwell Access'],
    address: 'Tunwar ji ka Jhalra, Jodhpur'
  },
  {
    id: 'desert-glamping-camps-jaisalmer',
    name: 'Serai Desert Glamping Tents',
    city: 'Jaisalmer',
    category: 'Desert Glamping' as const,
    pricePerNight: '₹16,000 / night',
    priceNumeric: 16000,
    rating: 4.8,
    reviewsCount: 220,
    image: 'https://images.unsplash.com/photo-1510312305653-8ed496efae75?auto=format&fit=crop&w=600&q=80',
    description: 'Luxury air-conditioned tented suites under the desert stars with bonfire folk performances and dune safaris.',
    amenities: ['Dune Camel Safaris', 'Campfire Folk Music', 'Private Plunge Pools', 'Stargazing Decks'],
    address: 'Sam Sand Dunes, Jaisalmer'
  },
  {
    id: 'aman-i-khas-ranthambore',
    name: 'Aman-i-Khas Wildlife Safari Camp',
    city: 'Ranthambore',
    category: 'Desert Glamping' as const,
    ...
    description: 'Mughal-style luxury tented wilderness camp situated on the threshold of Ranthambore Tiger National Park.',
    amenities: ['Private Safari Guides', 'Outdoor Firepit Banquets', 'Spa Tents', 'Organic Farm Dining'],
    address: 'Sherpur Khildipur, Ranthambore'
  },
  {
    id: 'laxmi-niwas-bikaner',
    ...
    reviewsCount: 210,
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=600&q=80',
    description: 'An Indo-Saracenic palace built in pink sandstone by Maharaja Ganga Singh, featuring hand-carved lattice lattice-work.',
    amenities: ['Museum Hall Dining', 'Billiards Room', 'Royal Lawns', 'Traditional Musicians'],
    address: 'Lal Garh Complex, Bikaner'
  },
  {
    id: 'mount-abu-hillside-retreat',
    name: 'Mount Abu Heritage Hillside Manor',
    city: 'Mount Abu',
    category: 'Budget Stay' as const,
    pricePerNight: '₹5,500 / night',
    priceNumeric: 5500,
    rating: 4.5,
    reviewsCount: 180,
    image: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=600&q=80',
    description: 'A cozy hillside colonial heritage villa overlooking Nakki Lake with terraced gardens and mountain air.',
    amenities: ['Lake View Balconies', 'Garden Cafe', 'Free Wifi', 'Fireplace Lounge'],
    address: 'Sunset Road, Mount Abu'
  },
  {
    id: 'pushkar-palace-resort',
    name: 'Pushkar Sacred Lake Palace',
    city: 'Pushkar',
    category: 'Budget Stay' as const,
    ...
    reviewsCount: 240,
    image: 'https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&w=600&q=80',
    description: 'Lakeside heritage property facing Pushkar Ghats with direct views of morning aarti and temple spires.',
    amenities: ['Ghat View Terrace', 'Ayurvedic Massage', 'Pure Veg Dining', 'Cultural Programs'],
    address: 'Choti Basti, Pushkar Lake'
  }
];

export * from './data/culinaryData';
